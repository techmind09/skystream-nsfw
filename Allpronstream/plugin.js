(function () {
    ...
    function parseVideoItems(html) {
        ...
        while ((match = itemPattern.exec(html)) !== null) {
            ...
            const fullUrl = href.startsWith('http') ? href : (manifest.baseUrl || "https://allpornstream.com") + href;
            const posterUrl = posterSrc.startsWith('http') ? posterSrc : (manifest.baseUrl || "https://allpornstream.com") + posterSrc;

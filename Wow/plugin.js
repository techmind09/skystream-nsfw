...
(function () {
    ...
    async function getHome(cb) {
        try {
            ...
            // Core Rows to load first for better UX performance
            ...
            // Full Category Map matching images 1000114084.png & 1000114086.png
            const categories = {
                ...coreCategories,
            ...
            // Speed Optimize: Load top core categories first to present quickly on screen
            for (const [categoryName, url] of Object.entries(coreCategories)) {
                try {
                    ...
                    console.error(`Error fetching core ${categoryName}: ${e.message}`);
                }
            }
            
            // Fallback inside main script if no rows parsed

 ...
 * Features: SkyStream Native Core Streaming Engine (Fixed Buffering)
 */
...
(function () {
    ...
    /**
     * 6. LOAD STREAMS (SKYSTREAM NATIVE WEB EXTRACTOR)
     * Yeh function page ke iframes se actual source nikal kar SkyStream Proxy ko feed karega.
     */
    async function loadStreams(url, cb) {
        try {
            ...
            // Step A: Webpage ke embedded player (iframe src) ko target karein
            ...
            if (streams.length > 0) {
                ...
                cb({ success: false, errorCode: "NO_STREAMS", message: "No compatible host streams detected." });
            }
        } catch (e) {
            cb({ success: false, errorCode: "PARSE_ERROR", message: e.message });
        }
